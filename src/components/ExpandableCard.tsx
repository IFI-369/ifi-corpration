...
export function ExpandableCard({
  ...
  return (
    <div
      className={cn(
        "bg-white dark:bg-zinc-950 dark:from-zinc-950 from-white w-full border py-2 px-3 my-5 rounded-lg",
        className
      )}
    >
      <div className="relative overflow-hidden bg-inherit dark:bg-inherit">
        ...
        <div
          ...
          className="ExpandCard absolute bottom-0 inset-x-0 h-28 bg-gradient-to-t from-inherit dark:from-inherit/50 to-transparent pointer-events-none data-[expanded=true]:opacity-0"
        ...
        <div
          className={cn(
            ...
            wide ? "w-full" : "w-fit",
            isExpanded ? "pt-2" : "absolute bottom-[0px] inset-x-0 w-"
          )}
        >
          <Button
            variant="outline"
